...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Mar 2020 pada 04.34
...
(2, 'Nuri', '$2y$12$2ucO4TIbo7XLAOZrjMK.P.YFT0jujCzGVYmRxs6r37jvcyh.ZCbM2', 'muhamadadzana20@gmail.com', '085801979435', 'Admin', 1, 'Banjarjo Kragilan Gantiwarno Klaten', 'Nuri.jpg'),
...
(12, 'Elsa', '$2y$12$2N9CAQviBRnB.BsmBiXvqubAKJRID0xACLU1QTAMwXr/S2FGaSajO', 'elsa@gmail.com', '098876654432', 'Kasir', 1, 'Banjarjo', 'baseline_person_black_36dp.png'),
(13, 'Donal', '$2y$10$69/g6BYqes1t8QbsVUg6oeZCZkrnlgzHtvtmtuja/.2vaQVfwCZvO', 'DonalBebek@gmail.com', '089908809908', 'Kasir', 1, 'Sanding omahku', 'baseline_person_black_36dp.png'),
...
(1, 1, 'Semen', 32, 55000, 'download.jpg', 1, 1),
...
(21, 12, 'Cat Tembok', 12, 75000, 'download2.jpg', 2, 2);

-- --------------------------------------------------------

--
-- Stand-in struktur untuk tampilan `dtbrg`
...
--
-- Stand-in struktur untuk tampilan `dtbrng`
-- (Lihat di bawah untuk tampilan aktual)
--
CREATE TABLE `dtbrng` (
`idBarang` int(11)
...
--
-- Dumping data untuk tabel `farian`
--
...
--
-- Struktur dari tabel `simpansementara`
--
...
--
-- Dumping data untuk tabel `simpansementara`
--
...
--
-- Indeks untuk tabel `simpansementara`
--
...
--
-- AUTO_INCREMENT untuk tabel `farian`
--
ALTER TABLE `farian`
...
--
-- AUTO_INCREMENT untuk tabel `simpansementara`
--
ALTER TABLE `simpansementara`
